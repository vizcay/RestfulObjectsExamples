...
(function() {
  ...
  $((function(_this) {
    return function() {
      return _this.TaskFormView = (function(superClass) {
        extend(TaskFormView, superClass);

        function TaskFormView() {
          _this.on_due_by_change = bind(_this.on_due_by_change, this);
          _this.on_project_change = bind(_this.on_project_change, this);
