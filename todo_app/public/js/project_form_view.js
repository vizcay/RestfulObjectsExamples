...
(function() {
  ...
  $((function(_this) {
    return function() {
      return _this.ProjectFormView = (function(superClass) {
        extend(ProjectFormView, superClass);

        function ProjectFormView() {
          _this.on_image_upload_change = bind(_this.on_image_upload_change, this);
          _this.on_description_change = bind(_this.on_description_change, this);
          _this.on_delete = bind(_this.on_delete, this);
          _this.on_cancel = bind(_this.on_cancel, this);
          _this.on_revert = bind(_this.on_revert, this);
          _this.on_save = bind(_this.on_save, this);
          _this.on_create = bind(_this.on_create, this);
          _this.display_png = bind(_this.display_png, this);
